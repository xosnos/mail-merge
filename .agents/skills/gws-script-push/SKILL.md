...
- **`--script`** *(Required)*: Script Project ID.
...
> [!CAUTION] This is a **write** command — confirm with the user before
> executing.

## See Also

- [gws-shared](../gws-shared/SKILL.md) — Global flags and auth
- [gws-script](../gws-script/SKILL.md) — All manage google apps script projects
  commands
