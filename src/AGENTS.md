...
| `services/SendEngine.js`   | Core batch send engine — variable substitution, dynamic CC/BCC, Drive attachments, quota management, timeout/resumption, tracking pixel injection |
