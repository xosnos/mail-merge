...
- **The "Test Email" Flow**: A dedicated "Send Test Email" button allows the user to send the merged version of Row 2 _only_ to their own email address. This allows them to verify variable substitution and formatting before committing.
